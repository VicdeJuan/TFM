...
\newpreg{5}{Identifica los monomios entre las siguientes expresiones:}
...
\section{Sesión 3}\label{app:ses_comp:3}
...
\Justificacion{de la posibilidad de elección}
	...
	Además, al ser resueltos en una plataforma online, son corregidos en el momento, provocando una retroalimentación sobre su desempeño inmediata\footnote{Una posible mecánica de la gamificación según \citeauthor{werbach2012win}\crossref{, descrita en \ref{mecanicas}}.}.
	%
...
\begin{figure}[hbtp]
\centering
\caption{Trabajo autónomo de la sesión 5.}
\label{RetoUnir}
\includegraphics[scale=0.4]{img/RetoUnir.png}
\end{figure}


\subsubsection{Test de la sesión 5}
\label{ses5:deberes}
...
\section{Sesión 6}\label{app:ses_comp:6}
...
Se propondrán ejercicios de deberes en \textit{edmodo}\crossref{ (ver \ref{ses7:deberes})} con el esquema utilizado anteriormente.
%
...
\section{Sesiones 8 y 9}\label{app:ses_comp:9}
...
Se dispone de 2 sesiones para su realización: la primera se trabajará individualmente (cada miembro del equipo tendrá una ficha ligeramente diferente\crossref{, ver \ref{ses8:indiv}}) y la segunda se trabajará cooperativamente\crossref{ (ver \ref{ses8:coop})}.
%
...
En esta sesión, no necesariamente la sesión siguiente a la sesión 9, tendrá lugar el examen de la unidad (si se considera que haya un examen para esta unidad\crossref{, ver \ref{eval}}).
%
\ifinapp
