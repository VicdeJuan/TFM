...
%
El total de puntos que podrán conseguir será 130, a los que, aplicando el bonus $\left(\text{multiplicar por } \frac{13+(\text{Aciertos} - \text{Errores})/2}{13}\right)$, se podría llegar a 205.
...
Se propondrán ejercicios de deberes en \textit{edmodo}\crossref{ (ver \ref{ses6:deberes})} con el esquema utilizado anteriormente.
%
...
Se dispone de 2 sesiones para su realización: la primera se trabajará individualmente (cada miembro del equipo tendrá una ficha ligeramente diferente\crossref{, ver \ref{ses7:indiv}}) y la segunda se trabajará cooperativamente\crossref{ (ver \ref{ses7:coop})}.
%
