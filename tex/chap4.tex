...
\begin{figure}[hbtp]
\centering
\caption{Restos de la muralla musulmana de Madrid.}
...
%
Entre los recursos desarrollados se encuentran la utilización de la plataforma edmodo para la resolución de ejercicios, los materiales didácticos disponibles en el aula para las exposiciones por parte del docente y la plataforma online \textit{Kahoot} para la sesión introductoria.
...
\begin{longtable}{|m{0.06\linewidth}|m{0.28\linewidth}|m{0.49\linewidth}|}
...
EG3\labeltext{EG3}{nato} & Logro \ref{logro::investigador_nato} & Se consigue mendiante la correcta resolución del primer ejercicio autónomo propuesto en el aula.\\\hline
EG6\labeltext{EG4}{context} & Logro \ref{logro::contextualizador} & Este logro tiene niveles y 3 subnieveles en cada nivel. Se obtendrá un subnivel por la aplicación de alguno de los contenidos de la clase de matemáticas en su vida cotidiana y su posterior explicación a la clase.\\\hline
EG4\labeltext{EG5}{comp} & Logro \ref{logro::investigador_comprometido} & Se consigue un nivel del logro por la realización de los deberes mínimos el primer día y 2 niveles por la realización de todos los deberes del primer día.\\\hline
EG5\labeltext{EG6}{avizor} & Logro \ref{logro::avizor} & Este logro también tiene niveles y 3 subniveles por nivel. 
%
...
\label{eval}
%
La evaluación que se propone para esta unidad didáctica es a través de un examen incluido en \ref{app:examen} con la ponderación que estuviera establecida en la \gls{PDA} y el trabajo de clase, que se medirá mediante los puntos y medallas obtenidos por cada alumno.
