...
\begin{itemize}
	...
	\item Docu 1 de \Arab: Expresiones algebraicas y su valor numérico.

Qué es un polinomio. Grado de un polinomio. Suma y diferencia de polinomios.
...
Mapa que se ha borrado el centro y hay que redibujar los caminos.
...
\begin{figure}[hbtp]
\centering
\caption{Reto de unir}
\label{Unir}
\includegraphics[scale=0.6]{img/RetoUnir.png}
\end{figure}
