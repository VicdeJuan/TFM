...
De cara a la preparación la prueba objetiva tendrán en edmodo un quizz que podrán hacer a modo de auto-evaluación cuantas veces quieran.
...
\begin{itemize}
	...
	\item\mylabel{explorador}{EG8} Medalla \logro{Explorador}{explorador} por hacerse la foto en el lugar del tesoro.
\end{itemize}


\paragraph{Economía de fichas}
%
Con los puntos de reputación obtenidos a lo largo de las sesiones se podrán comprar diversos privilegios.
%
Los posibles ítems de compras se encuentran en la tabla \ref{tbl:tienda}.
...
$n$ & ExtraQuizz	& Aumentar en 1 el número de ejercicios que se pueden hacer en edmodo para ganar puntos.\\\hline
...
\label{eval}
%
La evaluación que se propone para esta unidad didáctica es una evaluación tradicional, a través de una prueba objetiva incluida en \label{examen} con la ponderación que estuviera establecida en la programación didáctica anual y el trabajo de clase que se medirá mediante los puntos y medallas obtenidos por cada alumno.
%
La ponderación se explica más adelante.
