...
\paragraph{Gamificación no es lo mismo que Juegos serios}
...
Los elementos de la Gamificación son los elementos que podemos encontrar en los juegos, atendiendo a \cite{Hunicke04mda:a}:

\begin{itemize}
	\item \concept{Dinámicas}:
	\item \concept{Mecánicas}:
	\item \concept{Componentes}:
\end{itemize}
...
\section{La Gamificación en el aula}
...
\subsection{Para qué Gamificar en el aula}
...
\subsection{¿Se pueden gamificar las Matemáticas?}
...
\cleardoublepage
\chapter{Una propuesta de Gamificación}

\section{Revisión de la ley y del currículo}
...
\section{Dinámicas, mecánicas y componentes de la Gamificación}

\subsection{Dinámicas}

\paragraph{Narrativa}
\paragraph{Progresión}

\subsection{Mecánicas}

Las mecánicas que utilizaremos serán:
\paragraph{Retos},
\paragraph{Competición y cooperación},
\paragraph{Feedback},
\paragraph{Premios}
...
\paragraph{Puntos},
\paragraph{Medallas},
\paragraph{Jefes finales}...

\section{Programación anual Gamificada}

\subsection{Cobertura de los contenidos. Evaluación de las competencias. Incorporación de los Estándares de Aprendizaje Evaluables...}
...
\subsection{Puesta en marcha y evaluación. Detectar posibles mejoras}

\subsection{Propuestas de Gamificación para otros cursos y otras asignaturas.}
